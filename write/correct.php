...
<div style="padding:2em;width:50%">
	<div class="card">
	  <div class="card-body">
	  	...
	  	<small>ZADÁNÍ</small>
		<h5 class="top-padding"><b><?php if ($card["definition"]) {
      ...
      echo "<img src='" .
          ...
          "' style='max-width:50%;max-height:50vh'>";
  } ?>
		<hr>
		<small>VAŠE ODPOVĚĎ</small>
        <div class="d-flex flex-row justify-content-between">
		<p class="top-padding text-danger"><?php echo $you_said; ?></p>
        <a class="top-padding" href="override.php?set_id=<?php echo $set_id; ?>&card_id=<?php echo $card_id; ?>">Měl jsem pravdu</a>
    </div>
        <hr>
		<small>SPRÁVNĚ</small>
