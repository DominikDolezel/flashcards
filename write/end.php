...
<head>
    ...
    <?php
    $emojis = [
        "https://images.emojiterra.com/twitter/512px/1f389.png",
        "https://i.redd.it/m4ohq8yp2mu41.png",
        "https://images.emojiterra.com/twitter/v13.0/512px/1f525.png",
        "https://cdn-0.emojis.wiki/emoji-pics/twitter/partying-face-twitter.png",
        "https://images.emojiterra.com/twitter/v13.0/512px/1f3c5.png",
    ];
    $phrases = [
        "Hotovo! Dobrá práce!",
	  ...
	  <div class="card-body">
	  	<div class="d-flex justify-content-between align-items-center">
	  		<div class="d-flex justify-content-start align-items-center" style="padding-right:10px">
	  			<img src="<?php echo $emojis[
          array_rand($emojis, 1)
      ]; ?>" width="50px"><h3 style="padding-left:15px"><?php echo $phrases[
    array_rand($phrases, 1)
]; ?></h3>
	  		</div>
      ...
      if (isset($_COOKIE["focus_on"])) {
          if (strpos((string) $_COOKIE["focus_on"], (string) $card["id"])) {
              echo "<li class='list-group-item d-flex justify-content-between align-items-start'><div class='ms-2 me-auto'><div class='fw-bold'>" .
                  $card["term"] .
                  "</div>" .
                  $card["definition"] .
                  "</div></li>";
...
<?php setcookie("focus_on", "", time() - 3600, "/");
?>
