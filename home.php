     ...
     <div class="d-flex flex-row bd-highlight d-flex justify-content-start">
         <?php
            foreach($sets_to_show as $set_id) {
                ...
                echo "<div style='padding:2em;min-width:30%'><a href='set.php?set_id=" . (string)$set["id"] . "'><div class='card'><div class='card-body'><h5 class='card-title' style='font-family: Raleway, sans-serif;'>" . $set["name"] . "</h5><h6 class='card-subtitle'>" . (string)count($set["cards"]) . " karet</h6></div></div></a></div>";
            }
         ?>
         </div>
     </div>
